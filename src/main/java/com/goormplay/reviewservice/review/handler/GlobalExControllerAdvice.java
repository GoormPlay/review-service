package com.goormplay.reviewservice.review.handler;

import com.goormplay.reviewservice.review.dto.ErrorResultDto;
import com.goormplay.reviewservice.review.dto.ResponseDto;
...
public class GlobalExControllerAdvice {
    ...
    @ExceptionHandler
    public Object reviewValidError(MethodArgumentNotValidException e){
